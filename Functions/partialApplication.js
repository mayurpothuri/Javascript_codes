...
function preFillingFn(fn, preFilledVal) {
    //retunrs the "decorated function"
    const innerFn = (liveVal) => {
        //performs the actual "functionality with passed prefilled value" upon invocation of this "decorated function"
...
//invoke the generic function with prefilled value and getting the "decorated functionality[passed]"
...
//here we prefilled the actual functionality with one input, but in reality, ther are situation
